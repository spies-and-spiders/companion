...
var G__37968 = (((comma < (0)))?"":str.substring((comma + (1))).trimLeft());
var G__37969 = (n + (1));
var G__37970 = cljs.core.max.cljs$core$IFn$_invoke$arity$2(duration,(((((s < ms)) || ((ms < (0)))))?((1000) * cljs.core.parse_double(str.substring((0),s))):cljs.core.parse_long(str.substring((0),ms))));
str = G__37968;
n = G__37969;
duration = G__37970;
continue;
