...
var i_30343 = (self__.level + (1));
while(true){
if((i_30343 <= (new_level + (1)))){
(update[i_30343] = self__.header);

var G__30344 = (i_30343 + (1));
i_30343 = G__30344;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_30345 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30345[i]));
} else {
x__$2.forward.push((((i < links_30345.length))?(links_30345[i]):null));
}

if((i < links_30345.length)){
(links_30345[i] = x__$2);
} else {
links_30345.push(x__$2);
}
...
var i_30349 = (0);
while(true){
if((i_30349 <= self__.level)){
var links_30350 = (update[i_30349]).forward;
if((x__$1 === (((i_30349 < links_30350.length))?(links_30350[i_30349]):null))){
(links_30350[i_30349] = (x__$1.forward[i_30349]));

var G__30353 = (i_30349 + (1));
i_30349 = G__30353;
continue;
} else {
var G__30354 = (i_30349 + (1));
i_30349 = G__30354;
continue;
}
} else {
...
var G__30363 = nx;
var G__30364 = (level__$1 - (1));
x = G__30363;
level__$1 = G__30364;
continue;
} else {
var G__30367 = x;
var G__30368 = (level__$1 - (1));
x = G__30367;
level__$1 = G__30368;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__30382 = nx;
var G__30383 = (level__$1 - (1));
x = G__30382;
level__$1 = G__30383;
continue;
} else {
var G__30384 = x;
var G__30385 = (level__$1 - (1));
x = G__30384;
level__$1 = G__30385;
continue;
}
